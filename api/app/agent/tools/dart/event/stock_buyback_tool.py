...
from app.dart.domain.stock_buyback import get_stock_buyback_description
...
def stock_buyback_tool(corp_name: str, bgn_de: str, end_de: str) -> str:
    # Initialize services
    ...
    result = dart_report_event_service.get_stock_buyback(corp_name, bgn_de, end_de)
