...
from app.dart.domain.stock_retirement import get_stock_retirement_description
...
tool_description = f"""
### tool description
{get_stock_retirement_description()}
...
def stock_retirement_tool(corp_name: str, bgn_de: str, end_de: str) -> str:
    # Initialize services
    ...
    result = dart_report_event_service.get_stock_retirement(corp_name, bgn_de, end_de)
