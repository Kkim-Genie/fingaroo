...
from app.dart.domain.changed_capital import get_changed_capital_description

settings = get_settings()

tool_description = f"""
### tool description
{get_changed_capital_description()}
...
def changed_capital_tool(corp_name: str, bsns_year: int, reprt_code: str) -> str:
    # Initialize services
    ...
    result = dart_report_principal_service.get_changed_capital(corp_name, bsns_year, reprt_code)
