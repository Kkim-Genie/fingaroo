...
from app.dart.domain.dividend import get_dividend_description
...
def dividend_tool(corp_name: str, bsns_year: int, reprt_code: str) -> str:
    # Initialize services
    ...
    result = dart_report_principal_service.get_dividend(corp_name, bsns_year, reprt_code)
