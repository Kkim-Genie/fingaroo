...
from app.dart.domain.both_capital_decision import get_both_capital_decision_description
...
tool_description = f"""
### tool description
{get_both_capital_decision_description()}
...
def both_capital_decision_tool(corp_name: str, bgn_de: str, end_de: str) -> str:
    # Initialize services
    ...
    result = dart_report_event_service.get_both_capital_decision(corp_name, bgn_de, end_de)
