...
from app.dart.domain.company_divide_merge import get_company_divide_merge_description
...
tool_description = f"""
### tool description
{get_company_divide_merge_description()}
...
def company_divide_merge_tool(corp_name: str, bgn_de: str, end_de: str) -> str:
    # Initialize services
    ...
    result = dart_report_event_service.get_company_divide_merge(corp_name, bgn_de, end_de)
