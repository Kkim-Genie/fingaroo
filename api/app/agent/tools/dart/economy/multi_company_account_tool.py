...
from app.dart.domain.multi_company_account import get_multi_company_account_description
...
tool_description = f"""
### tool description
{get_multi_company_account_description()}
...
def multi_company_account_tool(corp_name: str, bsns_year: int, reprt_code: str) -> str:
    # Initialize services
    ...
    result = dart_report_economy_service.get_multi_company_account(corp_name, bsns_year, reprt_code)
