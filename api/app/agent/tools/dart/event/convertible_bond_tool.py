...
from app.dart.domain.convertible_bond import get_convertible_bond_description
...
tool_description = f"""
### tool description
{get_convertible_bond_description()}
...
def convertible_bond_tool(corp_name: str, bgn_de: str, end_de: str) -> str:
    # Initialize services
    ...
    result = dart_report_event_service.get_convertible_bond(corp_name, bgn_de, end_de)
