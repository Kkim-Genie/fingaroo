...
from app.dart.domain.company_divide import get_company_divide_description
...
tool_description = f"""
### tool description
{get_company_divide_description()}
...
def company_divide_tool(corp_name: str, bgn_de: str, end_de: str) -> str:
    # Initialize services
    ...
    result = dart_report_event_service.get_company_divide(corp_name, bgn_de, end_de)
