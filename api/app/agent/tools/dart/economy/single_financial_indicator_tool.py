...
from app.dart.domain.single_financial_indicator import get_single_financial_indicator_description
...
tool_description = f"""
### tool description
{get_single_financial_indicator_description()}
...
def single_financial_indicator_tool(corp_name: str, bsns_year: int, reprt_code: str, idx_cl_code: str) -> str:
    # Initialize services
    ...
    result = dart_report_economy_service.get_single_financial_indicator(corp_name, bsns_year, reprt_code, idx_cl_code)
