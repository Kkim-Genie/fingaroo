...
from app.dart.domain.total_stock import get_total_stock_description

settings = get_settings()

tool_description = f"""
### tool description
{get_total_stock_description()}
...
def total_stock_tool(corp_name: str, bsns_year: int, reprt_code: str) -> str:
    # Initialize services
    ...
    result = dart_report_principal_service.get_total_stock(corp_name, bsns_year, reprt_code)
